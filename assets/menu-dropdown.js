...
class MegaMenu extends HTMLElement {
  constructor() {
    ...
    this.querySelector(".header__menu-item").addEventListener('focusin', this.handleMouseover.bind(this));
    this.querySelector(".header__menu-item").addEventListener('mouseenter', this.handleMouseover.bind(this));
  }
